...
class LineageBuilder:
    ...
    def build_lineages(
        ...
        ],  # (frame, cell_id_t1, cell_id_t2, conf)
    ...
    def _integrate_divisions(
        self, divisions: List[DivisionEvent], cell_to_track: Dict[Tuple[int, int], int]
    ) -> None:
    ...
    def _build_trees(self) -> List[LineageTree]:
        ...
        root_ids = [
            tid for tid, track in self.tracks.items() if track.parent_id is None
        ]
